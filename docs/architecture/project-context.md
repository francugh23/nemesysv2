...
SY 2026-2027 operational Curriculum is configured from the Phase 22C clean baseline. The active Year has three Terms, five organizational Sections (Grades 7-11 A), 32 full-year JHS Offerings, five full-year Grade 11 Core Offerings, and three Grade 11 elective Offerings. All eight SHS Offerings remain `PROVISIONAL_DEPED`; school approval and Curriculum finalization are pending legitimate approval references. The dashboard correctly reports five organizational Sections but zero enrollment-derived Active Sections until active Enrollments exist. The retained Phase 22C rollback database is `nemesysv2_phase22c_rollback_20260901062030`.
...
- Applied Phase 22D-A created the active 2026-2027 Academic Year with the approved three-Term calendar, five organizational Sections (Grades 7-11 A), 40 Offerings, 116 Offering-Term rows, eight `PROVISIONAL_DEPED` SHS contexts, and six elective-policy scopes. There are zero school-approved SHS Offerings and zero Curriculum finalizations. The audited bootstrap created 56 records. Dashboard Active Sections remains zero until active Enrollments exist, while organizational Sections remains five. Phase 22D-B is pending legitimate school approval references for the exact eight provisional SHS Offerings.
