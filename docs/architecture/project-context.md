...
Phase 21C SSHS Curriculum Term Applicability is complete; authenticated browser verification remains pending before production.

### Current Objective

Academic Year is the canonical period identity for academic configuration and operations, with source-backed SSHS Term applicability, explicit Curriculum adoption mapping, and preserved operational history.
...
- Official-source-corrected SSHS Term applicability with Grade 11 three-Term Offerings, unresolved Grade 12 one-Term references, idempotent catalog reconciliation, and preserved school-approved/student history
...
- Phase 20B/21C maintains a controlled `PROVISIONAL_DEPED` source-backed SSHS reference catalog from DepEd DO 017, s. 2026, DM 012, s. 2026, DM 036, s. 2026, and the DepEd Strengthened SHS Program curriculum-guide catalog. Grade 11 Core and TechPro BOW candidates have Offerings for all three configured 2026-2027 Terms. Grade 12 TechPro pilot references establish one-Term duration but no universal Term 1/2/3 assignment, so they remain `ONE_CONFIGURED_TERM_UNRESOLVED` without automatic active Offerings. Academic Electives remain unresolved references without automatic Offerings. Population reconciles only exact legacy provisional signatures, preserves deliberate school configuration and operational history, and never asserts NVGCHS availability, school approval, or Grade 12 pilot participation.
