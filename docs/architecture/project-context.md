...
Phase 21C SSHS Curriculum Term Applicability and the focused Phase 21D-A Curriculum UI bug fixes are complete; authenticated browser verification remains pending before production.
