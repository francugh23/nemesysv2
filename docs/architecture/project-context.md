...
Phase 21C SSHS Curriculum Term Applicability, the focused Curriculum UI bug fixes, Phase 21D-A SHS Enrollment Foundation, and Phase 21D-B1 Progressive SHS Foundation are complete; authenticated browser verification remains pending before production.
