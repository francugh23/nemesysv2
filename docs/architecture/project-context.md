...
Phase 22D-C1 Grade 11 Core alignment and provisional Offering setup is complete. The local `nemesysv2` development database has ACTIVE Academic Year 2026-2027 with its approved three-Term calendar, six organizational Section definitions for Grades 7-12, 32 Grade 7-10 full-year JHS Subject Offerings, and five Grade 11 full-year Core Offerings pending genuine school approval; its pre-reset state remains in a retained local rollback database. Authenticated browser verification remains pending before production.
...
- Phase 22D-B regular JHS Curriculum setup with 32 full-year Grade 7-10 Subject Offerings only
- Phase 22D-C1 Grade 11 Core title alignment and five provisional full-year Core Offerings only
...
- Phase 22D-B used the existing authorized Subject Offering service to create the exact regular JHS matrix for ACTIVE 2026-2027: FIL, ENG, MATH, SCI, AP, MAPEH, TLE, and GMRC in each Grade 7-10, with all three configured Terms. The resulting 32 active Offerings and 96 Offering-Term rows reuse the existing 32 Grade 7-10 reusable Subjects; all 37 Subjects remain unchanged. Grade 11/12 Offerings, SSHS contexts, policies, finalization, Teachers, Students, Enrollments, participation, results, Grades, and corrections remain zero. The operational dashboard Curriculum Offering count is 32 while Active Students, Enrollments, and Sections remain zero. JHS derivation and Phase 21F-B regressions pass when database-mutating suites run independently; the only Phase 21F-A failure is its Grade 11 Offering fixture, intentionally absent until a later SHS phase.
- Phase 22D-C1 aligned `SSHS-G11-CORE-01` to Effective Communication / Mabisang Komunikasyon and `SSHS-G11-CORE-05` to Pag-aaral ng Kasaysayan at Lipunang Pilipino through the normal audited Subject service. It then created exactly five Grade 11 Core Offerings through the normal audited Offering service, each covering all three configured Terms with Core classification, no cluster, official DepEd DM 012/DO 017 provenance, and `PROVISIONAL_DEPED` status. The active database now has 37 Subjects, 37 Offerings, 111 Offering-Term rows, and five SSHS contexts. No Grade 12 Offering, elective Subject or Offering, policy, school approval, finalization, Teacher, Student, Enrollment, participation, result, Grade, or correction was created. Phase 21F-A now supplies its approved SHS fixture only within its rollback transaction and passes; retired Phase 20C historical-read coverage remains inapplicable to this deliberately zero-history baseline.
