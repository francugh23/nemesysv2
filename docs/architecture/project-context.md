...
Phase 21C SSHS Curriculum Term Applicability, the focused Curriculum UI bug fixes, Phase 21D-A SHS Enrollment Foundation, Phase 21D-B Progressive SHS Current-Term Enrollment, Phase 21D-C Immutable SHS Term Result Foundation, Phase 21D-D SHS Term Result Interpretation Policy Foundation, Phase 21E-A/B Academic Configuration Navigation and Curriculum Operational UX, Phase 21E-C Academic Year Configuration Composition, Phase 21E-D DepEd Reference Catalog Retirement From User Workflow, Phase 21E-E1 Curriculum Finalization And Dependency Guards, and Phase 21E-E2-A Controlled Curriculum Correction Foundation are complete; authenticated browser verification remains pending before production.
...
- The correction Service owns serializable locking, exact successor validation, three audits, and bounded transaction retry. PostgreSQL scopes the E1 exception to the exact correction identity and validates lifecycle, effective Term, lineage, snapshots, archive state, and complete JHS/SHS replacement facts at commit.
- SHS progression resolves active replacement ancestry prospectively: ancestor Core participation suppresses only Terms it already covers, and corrected elective participation is represented by the active successor identity for additive current-Term selection without moving historical rows.
